export const STATUS_IDEIA_COM_RESPONSAVEL = ['Reservada','Em desenvolvimento','Utilizada'];

export function dadosDeUsoIdeia(status,responsavelUso,tccVinculado){
  if(!STATUS_IDEIA_COM_RESPONSAVEL.includes(status))return {responsavelUso:undefined,tccVinculado:undefined};
  return {
