// Funcionalidade exclusiva do AcervoTCC: aprovação de contas, perfis e vínculos acadêmicos.
...
export default class UsuarioController{
    constructor(caminhoBase='admin/'){
        ...
        this.del = async(req, res)=>{
            ...
            // Funcionalidade exclusiva do AcervoTCC: desativa contas vinculadas para preservar o histórico.
