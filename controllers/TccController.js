...
// Funcionalidade exclusiva do AcervoTCC: fluxo completo de envio, avaliação e publicação de TCCs.
...
export default class TccController{
    constructor(caminhoBase='tcc/'){
        ...
        this.revisar = async(req, res)=>{
            // Funcionalidade exclusiva do AcervoTCC: somente o orientador libera o TCC aprovado no site.
            const tcc = await Tcc.findById(req.params.id);
            if (!tcc) throw new Error('TCC não encontrado.');
