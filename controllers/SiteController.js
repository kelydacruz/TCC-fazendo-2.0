...
export default class SiteController {
  home = async(req, res) => {
    ...
    res.render('home-db',{title:'Início',recentes,maisAcessados,cursos:cursosDb,anos:anos.sort((a,b)=>b-a),areas:areas.sort(),stats:{tccs:totalTcc,views:totalViews[0]?.total||0,downloads:totalDownloads[0]?.total||0,ideias:totalIdeias}});
  };
